<template>
  <form class="card" @submit.prevent="$emit('log')">
        ...
        <div class="field">
          ...
          <div class="control">
            <input
              class="input"
              type="text"
              placeholder="Input an awesome title to share with!"
    ...
    <footer class="card-footer">
      <button class="button is-link is-dark card-footer-item" type="submit">
        Submit
      </button>
      <button
